...
| COUNT_SAMPLE_FREQUENCY | N         | specifies count-based sample frequency |
| TIME_SAMPLE_FREQUENCY  | N         | specifies frequency for time-based sampling |
| TIME_SAMPLE_DURATION   | N         | specifies duration for time-based sampling |
